...
contract NotBEANZ is ERC721A, Ownable {
    ...
    constructor() ERC721A("NotBEANZ", "NotBEANZ") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount <= MAX_MINT, "Mint Limit is 20");
        require(minted[_caller]+_amount <= MAX_MINT, "Max Mint Limit is 20!");

        if(totalSupply() > FREE_MAX_SUPPLY){
            require(_amount * price == msg.value, "Invalid funds provided, Free supply exiceeded");
        }
